...
public class Batalla implements Serializable {
    ...
    public int turno(Pokemon atacante, Ataque ataqueElegido, Pokemon atacado) {
        // Si ambos tienen la misma velocidad, el primero que llege a la batalla, lo
        // ataca
        ...
        System.out.println("A " + atacado.getNombre() + " le quedan " + atacado.getHp() + "/" + atacado.getHPMAX()
                + " puntos de vida");
        return 0;
    }
