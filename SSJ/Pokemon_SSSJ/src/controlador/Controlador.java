...
import excepciones.LimitePartidasException;
...
public class Controlador implements PersistenciaBatallas {
    ...
    public void setBatalla(Batalla batalla) {
        ...
        for (Pokemon pokemon : entrenador1.getEquipo()) {
            pokemon.setImagen(); // este método asigna la imagen correcta según el tipo
        }
...
// getter para el manejador de logros
    ...
    public boolean EntrenadoresRepetidos(String entrenador1, String entrenador2) {
        // Este método se usa para verificar si los entrenadores son iguales
       ArrayList<Batalla> batallas = PersistenciaBatallas.cargar();
        for (Batalla b : batallas) {
            if (b.getEntrenador1().getNombre().equals(entrenador1) || b.getEntrenador2().getNombre().equals(entrenador1) || b.getEntrenador1().getNombre().equals(entrenador2) && b.getEntrenador2().getNombre().equals(entrenador2)) {
                return true;
            }
        }
        return false;
    ...
    public void guardarBatalla() {
        try{
            ...
            if (batallas.size() == 4) {
                ...
                throw new LimitePartidasException("No se pueden guardar más de 4 batallas.");
            }
        ...
        catch (LimitePartidasException e){
            vista.mostrarLogro("", "No se pueden guardar más de 4 batallas", "Error");
        } 
        catch(Exception e){
