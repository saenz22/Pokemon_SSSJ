 ...
 * Ver por qué no muestra los logros
 */
public class VistaPokemonConsola implements VistaPokemon {
    ...
    public void menuPrincipal() {
        while (true) {
            ...
            System.out.println("6. Historial de ataques");
            ...
            try {
                switch (opcion) {
                    ...
                    case "5":
                        ...
                        System.exit(0);
                    case "6":
                        mostrarHistorialAtaques(Controlador.getHistorialAtaques(), controlador.getOrden().get(1), controlador.getOrden().get(0));
                    default:
    ...
    public void menuBatalla() {
        while (true) {
            ...
            System.out.println("2. Historial de ataques");
            System.out.println("3. Logros");
            System.out.println("4. Reanudar batalla");
    ...
    private void mostrarPartidasGuardadas() {
        ...
        System.out.println("\n--- PARTIDAS GUARDADAS ---");
        System.out.println("0. Borrar partidas");
        for (int i = 0; i < batallas.size(); i++) {
            Batalla b = batallas.get(i);
            System.out.println((i + 1) + ". " + b.getEntrenador1().getNombre() + " vs " + b.getEntrenador2().getNombre());
        }
        System.out.print("Selecciona el número de la partida a cargar (o 0 para cancelar): ");
        try {
            int seleccion = Integer.parseInt(scanner.nextLine());
            if (seleccion == 0) {
                System.out.println("¿Seguro de que quieres borrar todas las partidas?");
                System.out.println("1. Si");
                System.out.println("2. No");
                System.out.print("Selecciona una opción: ");
                int opcion = Integer.parseInt(scanner.nextLine());
                if (opcion == 1) {
                    System.out.println("Borrando partidas...");
            ...
            if (seleccion > 0 && seleccion <= batallas.size()) {
                ...
                controlador.setBatalla(batallas.get(seleccion - 1)); // Método para continuar la partida cargada
                continuar();
                limpiarConsola();
            }
    ...
    private void mostrarLogrosConsola() {
        ...
        for (Logros logro : Logros.values()) {
            ...
            String estado = (e != null) ? "Logrado por (" + e.getNombre() + ")" : "x";
    ...
    private void mostrarCreditos() {
        ...
        System.out.println("Univalle / Prof. Joshua / Año 2025");
        limpiarConsola();
    }
    ...
    public void pokemones() {
        ...
        controlador.notificarLogro("Pokemon Legendario", "Captura a un pokemon de nivel 90 o superior", "");
        limpiarConsola();
        controlador.avanzarEscena();
    }
    ...
    public void elegirAtaque(Pokemon pokemon) {
        ...
        while (true) {
            try {
                ...
                System.out.println("0. Menú de batalla");
                ...
                else if (opcion >= 1 && opcion <= ataques.size()) {
                    System.out.println("Has elegido usar " + ataques.get(opcion - 1).getNombre());
                    controlador.agregarAtaqueHistorial(ataques.get(opcion - 1));
                    break;
                } else {
    ...
    public void ganador(Entrenador entrenador) {
        ...
        System.out.println("Recopilación de logros:");
        controlador.llamadaAgregarLogro(controlador.getListaEntrenadores().get(0));
        controlador.llamadaAgregarLogro(controlador.getListaEntrenadores().get(1));
        limpiarConsola();
        menuPrincipal();
    }
